...
class PermissionSeeder extends Seeder
{
    private array $permissions = [
        ...
        'admin' => ['manage users', 'assign roles', 'manage roles', 'view audit logs', 'manage visiting controllers', 'remove inactive controllers', 'certifications:write', 'documents:write', 'feedback:read', 'feedback:write', 'manage contributors'],
