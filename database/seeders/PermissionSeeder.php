...
class PermissionSeeder extends Seeder
{
    private array $permissions = [
        ...
        'admin' => ['manage users', 'assign roles', 'manage roles', 'view audit logs', 'manage visiting controllers', 'manage loas', 'documents:write', 'feedback:read', 'feedback:write', 'manage contributors'],
